...
$user1 = $I->addUserFixture(['email' => 'api.v2.nami8@ciklum.com']);
...
$restaurant1 = $I->addRestaurantFixture(
    [
        'email'                 => 'api.v2.support1@myrestaurant.com',
...
$user2 = $I->addUserFixture(['email' => 'api.v2.nami9@ciklum.com']);
...
$user3 = $I->addUserFixture(['email' => 'api.v2.nami10@ciklum.com']);
...
$I->sendGET('/api/v2/restaurants/search.json', $param);
