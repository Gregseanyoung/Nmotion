...
$users = [
    0 => $I->addUserFixture(['email' => 'api.v2.order.fail2-nopayforfriends-user.user@nmotion.pp.ciklum.com']),
    1 => $I->addUserFixture(['email' => 'api.v2.order.fail2-nopayforfriends-friend1.user@nmotion.pp.ciklum.com'])
];
