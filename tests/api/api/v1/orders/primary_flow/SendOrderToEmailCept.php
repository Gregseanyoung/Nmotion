...
$user = $I->addUserFixture(['email' => 'api.order.sendordertoemail.user@nmotion.pp.ciklum.com']);

$I->willEvaluateAuthorizationToken($user['username'], $user['password']);

$restaurant = $I->addRestaurantFixture(
    [
        'email'          => 'api.order.sendordertoemail.restaurant@nmotion.pp.ciklum.com',
        'adminUser'      => [
            'email' => 'api.order.sendordertoemail.admin@nmotion.pp.ciklum.com'
        ],
        'address'        => [],
        'menuCategories' => [
            [
...
$I->sendPOST('/api/v1/orders/' . $order['id'] . '/sendtoemail.json');
$I->seeResponseIsJson();
