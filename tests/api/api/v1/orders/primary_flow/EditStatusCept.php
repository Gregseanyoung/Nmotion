...
$restaurant = $I->addRestaurantFixture(
    [
        'email'          => 'api.order.patch-guest.restaurant-email@nmotion.pp.ciklum.com',
        'adminUser'      => [
            'email' => 'api.order.patch-guest.admin-email@nmotion.pp.ciklum.com'
        ],
        'address'        => [],
        'menuCategories' => [
            [
...
$I->sendPATCH('/api/v1/orders/' . $order['id'] . '.json', ['status' => ORDER_STATUS_PENDING_PAYMENT]);
$I->seeResponseIsJson();
