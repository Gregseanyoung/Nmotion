...
$users = [
    0 => $I->addUserFixture(['email' => 'api.order.notpayforfriends-user.user@nmotion.pp.ciklum.com']),
    1 => $I->addUserFixture(['email' => 'api.order.notpayforfriends-friend1.user@nmotion.pp.ciklum.com']),
    2 => $I->addUserFixture(['email' => 'api.order.notpayforfriends-friend2.user@nmotion.pp.ciklum.com']),
    3 => $I->addUserFixture(['email' => 'api.order.notpayforfriends-friend3.user@nmotion.pp.ciklum.com']),
    4 => $I->addUserFixture(['email' => 'api.order.notpayforfriends-friend4.user@nmotion.pp.ciklum.com'])
];
...
$restaurant = $I->addRestaurantFixture(
    [
        'email'          => 'api.order.notpayforfriends.restaurant-email@nmotion.pp.ciklum.com',
        'adminUser'      => [
            'email' => 'api.order.notpayforfriends.admin-email@nmotion.pp.ciklum.com'
        ],
        'address'        => [],
        'menuCategories' => [
            [
...
$linkEntries = [
    ...
    ['uri' => '/api/v1/orders/' . $orders[3]['id'], 'link-param' => 'rel="slave"']
];
