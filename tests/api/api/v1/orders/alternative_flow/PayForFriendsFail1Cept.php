...
$users = [
    0 => $I->addUserFixture(['email' => 'api.order.fail1-payforfriends-user.user@nmotion.pp.ciklum.com']),
    1 => $I->addUserFixture(['email' => 'api.order.fail1-payforfriends-friend1.user@nmotion.pp.ciklum.com'])
];
...
$I->sendLINK('/api/v1/orders/' . $orders[0]['id'], []);
$I->seeResponseIsJson();
