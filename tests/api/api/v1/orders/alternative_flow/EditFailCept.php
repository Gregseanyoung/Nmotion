...
$restaurant = $I->addRestaurantFixture(
    [
        'email'          => 'api.order.edit-guest.fail.restaurant@nmotion.pp.ciklum.com',
        'adminUser'      => [
            'email' => 'api.order.edit-guest.fail.admin@nmotion.pp.ciklum.com'
        ],
        'address'        => [],
        'menuCategories' => [
            [
...
foreach ($masterStatusesThatDoNotAllowEditSlaveOrder as $status) {
    ...
    $I->sendPUT('/api/v1/orders/' . $slaveOrder['id'] . '.json', $updateParams);
    $I->seeResponseIsJson();
