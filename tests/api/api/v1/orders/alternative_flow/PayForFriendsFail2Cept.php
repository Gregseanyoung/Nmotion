...
$users = [
    0 => $I->addUserFixture(['email' => 'api.order.fail2-payforfriends-user.user@nmotion.pp.ciklum.com']),
    1 => $I->addUserFixture(['email' => 'api.order.fail2-payforfriends-friend1.user@nmotion.pp.ciklum.com'])
];
