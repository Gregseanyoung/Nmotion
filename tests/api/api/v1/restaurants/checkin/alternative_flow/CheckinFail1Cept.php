...
$restaurant = $I->addRestaurantFixture(
    [
        'email'          => 'checkin.bad.params.test@nmotion.pp.ciklum.com',
        'visible'        => 1,
        'adminUser'      => [
            'email' => 'checkin.bad.params.test@nmotion.pp.ciklum.com'
        ],
...
$I->sendPOST('/api/v1/restaurants/' . $restaurant['id'] . '/checkin');
$I->seeResponseIsJson();
$I->seeResponseCodeIs(HTTP_RESPONSE_PRECONDITION_FAILED);
$I->seeResponseContainsJson(['success' => false]);

$I->sendPOST('/api/v1/restaurants/' . $restaurant['id'] . '/checkin', ['table' => 'abc']);
$I->seeResponseIsJson();
$I->seeResponseCodeIs(HTTP_RESPONSE_PRECONDITION_FAILED);
$I->seeResponseContainsJson(['success' => false]);
