...
$user1 = $I->addUserFixture(['email' => 'api.user.edit.fail1.user1@nmotion.pp.ciklum.com']);
$user2 = $I->addUserFixture(['email' => 'api.user.edit.fail1.user2@nmotion.pp.ciklum.com']);
...
$I->sendPUT("/api/v1/users/{$user2['id']}.json", $params);
$I->seeResponseIsJson();
