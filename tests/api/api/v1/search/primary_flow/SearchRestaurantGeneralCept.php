...
defined('POSITION_LATITUDE') || define('POSITION_LATITUDE', -41.288889); // Wellington, New Zealand
defined('POSITION_LONGITUDE') || define('POSITION_LONGITUDE', 174.777222); // Wellington, New Zealand
...
for ($i = 0; $i < 9; $i++) {
    $email = 'vas.restaurant.search.' . $i . '@ciklum.com';

    $delta = ((int) ($i / 4) + 1) * 0.08;

    $restaurant = $I->addRestaurantFixture(
        [
            'email'          => 'support@restaurant' . $i . '.fake.com',
            'name'           => $names[$i],
...
$I->sendGET(
    '/api/v1/restaurants/search.json',
