...
class Restaurant
{
     ...
     * Set nmWebsite
     *
     * @param boolean $nmWebsite
     * @return Restaurant
     */
    public function setNmWebsite($nmWebsite)
    {
     ...
     * @return boolean 
     */
    public function getNmWebsite()
    {
        return $this->nmWebsite;
    }
     ...
     * Set nmSiteUrl
     *
     * @param string $nmSiteUrl
     * @return Restaurant
     */
    public function setNmSiteUrl($nmSiteUrl)
    {
        $this->nmSiteUrl = $nmSiteUrl;
     ...
     * @return string 
     */
    public function getNmSiteUrl()
    {
        return $this->nmSiteUrl;
    }

    /**
     * Add menuCategories
     *
     * @param \Nmotion\NmotionBundle\Entity\MenuCategory $menuCategories
     * @return Restaurant
     */
    public function addMenuCategorie(\Nmotion\NmotionBundle\Entity\MenuCategory $menuCategories)
    {
        $this->menuCategories[] = $menuCategories;
     ...
     * @param \Nmotion\NmotionBundle\Entity\MenuCategory $menuCategories
     */
    public function removeMenuCategorie(\Nmotion\NmotionBundle\Entity\MenuCategory $menuCategories)
    {
